...
| Assignment Groups | `/api/v1/assignment_groups` | `simplemdm_assignmentgroup` | `simplemdm_assignmentgroup` | Covered (resource manages priority, app_track_location, assignment membership, remove_others handling, and app/profile sync actions) |
